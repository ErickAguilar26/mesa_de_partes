...
if(isset($_POST)){
    ...
    if(empty($informacionSolicitada)){
        $errores['informacionSolicitada'] = 'La informacion solicitada está vacia.';
    }
    else{
        if(!is_string($informacionSolicitada)){
            ...
            if(strlen($informacionSolicitada) > 200){
                $errores['informacionSolicitada'] = 'La informacion solicitada no debe pasar los 200 carácteres.';
            }
        }
    }
    //validando area
    ...
    if(count($errores) == 0){
            ...
            $sql7 = "INSERT INTO ee_operacion VALUES (null,2,'Ingresó un nuevo tramite = $idTramite acceso = $idAcceso',SYSDATE());";
